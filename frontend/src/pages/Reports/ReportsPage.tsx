...
export const ReportsPage: React.FC = () => {
  ...
  return <div className="space-y-6"><div><h1 className="text-2xl font-bold text-slate-900 dark:text-white">Histórico de análises</h1><p className="text-sm text-slate-500">Dados obtidos através do seu histórico no FinanceAI.</p></div>
